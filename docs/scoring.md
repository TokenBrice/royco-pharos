...
Pharos remains the vault/base-asset source of truth and is shown verbatim, including its letter grade. RoycoPharos scores the tranche seat independently in three layers: Pharos base asset, curated exposure, and tranche structure. A well-buffered Senior can score above the whole-vault Pharos score only through explicit Senior cushion credit, while a Junior can score below it because it absorbs first loss.
