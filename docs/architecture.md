...
- Surface Pharos peg-stability/depeg facts, the five report-card dimensions, and named upstream dependencies as evidence when reported; do not silently infer them when absent.
